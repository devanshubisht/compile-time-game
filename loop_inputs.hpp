...
// The file gets the current state the game, before it is combined to the new
// state.

constexpr KeyboardInput keyboard_input =
    KeyboardInput::KEYBOARD_INPUT; // Get the current keyboard input as a macro
